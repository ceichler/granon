 ...
 * to a relation of type pf with same the value and a random source related to T by t
 * Neither S, O or T can be the target of pi
 * @author ceichler
 *
 */
public class RandomTransform extends Operator {
	 ...
	 */
	public RandomTransform(String x, String s,String S,String t,String T,String o, String O, String pi, String pf) {
		r = Grammar.randomTransform.getClone();
		this.x = x;
		this.s= s;
		this.S = S;
		this.o = o;
	 ...
	 * same for o, O and t, T
	 */
	public RandomTransform(String s,String S,String t,String T,String o, String O, String pi, String pf) {
